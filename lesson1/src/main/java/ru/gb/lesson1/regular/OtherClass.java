...
public class OtherClass {
     ...
     * @param a делимое
     * @param b делитель
     * @return частное a и b, без проверки на переполенение переменной
     */
    public static int div(int a, int b) {
        return a / b; // возврат без проверки переполнения переменной
    }
     ...
     * @return произведение a и b, без проверки на переполенение переменной
     */
     ...
     * @param a уменьшаемое
     * @param b вычитаемое
     * @return разность a и b, без проверки на переполенение переменной
     */
